 ...
 */
export declare const getClerkInstance: (options?: import("./types").BuildClerkOptions | undefined) => import("@clerk/clerk-react").HeadlessBrowserClerk | import("@clerk/clerk-react").BrowserClerk;
