...
const ConnectToTerraButton = (props) => {
    const defaultClickHandler = () => {
        alert(`Please define a function which calls your backend for a widget session URL. Visit our docs for more information. ${process.env.TERRA_UI_DOCS}`);
    };
    return (reactExports.createElement("button", { className: "flex items-center justify-around bg-blue-500 hover:bg-blue-600 text-bold py-2 px-4 rounded-full transition duration-300 ease-in-out transform hover:scale-105 font-serif", onClick: props.onClick ? props.onClick : defaultClickHandler },
...
export { ConnectToProviderButton as ConnectToProvider, ConnectToTerraButton };
